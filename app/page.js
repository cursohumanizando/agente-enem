...
function buildPrompt({ disciplina, niveis, tipoItem, tema, qtd, offset = 0 }) {
  ...
  return "Você é elaborador ENEM especialista em Ciências Humanas.\n\n" +
    ...
    "8. RECURSO VISUAL OBRIGATÓRIO: pelo menos 1 a cada 3 questões DEVE ter recursoVisual preenchido. Sempre que o tema envolver dados geográficos, históricos, sociais ou estatísticos, inclua um recurso visual. Preencha: tipo (mapa/gráfico/tabela/charge/fotografia/infográfico), descricao (o que a imagem mostraria em detalhes), fonteRecurso (URL ou publicação real onde encontrar/baixar, ex: IBGE ibge.gov.br, INPE inpe.br, Atlas Histórico etc). Questões de nível Médio e Difícil devem preferencialmente ter recurso visual.\n\n" +
  ...
  async function gerarNoEstilo() {
    ...
    function buildPromptLote(offset, qtdLote) {
      ...
      return "Você é elaborador ENEM. Gere EXATAMENTE " + qtdLote + " questão(ões) novas no estilo abaixo.\n\n" +
        ...
        "9. RECURSO VISUAL: pelo menos 1 a cada 3 questões DEVE ter recursoVisual preenchido com tipo, descricao detalhada e fonteRecurso (URL real para baixar). Questões de nível Médio e Difícil devem preferencialmente ter recurso visual.\n\n" +
        "Responda SOMENTE JSON válido sem markdown:\n" +
