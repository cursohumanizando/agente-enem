  ...
  async function gerarNoEstilo() {
    ...
    function buildPromptLote(offset, qtdLote) {
      ...
      return "Você é elaborador ENEM. Gere EXATAMENTE " + qtdLote + " questão(ões) novas no estilo abaixo.\n\n" +
        ...
        "10. RECURSO VISUAL: pelo menos 1 a cada 3 questões.\n" +
        "11. DOIS TEXTOS: pelo menos 1 a cada 4 questões (Médio/Difícil).\n\n" +
        "Responda SOMENTE JSON válido sem markdown:\n" +
        '{"questoes":[{"tema":"","nivel":"Fácil|Médio|Difícil","textoBase":"","fonte":"","comando":"","recursoVisual":null,"opcoes":[{"letra":"A","texto":"","correta":false,"explicacao":""},{"letra":"B","texto":"","correta":false,"explicacao":""},{"letra":"C","texto":"","correta":false,"explicacao":""},{"letra":"D","texto":"","correta":false,"explicacao":""},{"letra":"E","texto":"","correta":false,"explicacao":""}],"gabarito":"","habilidade":"","competencia":"","eixo":""}]}';
    }
